<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:113:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\public/../application/admin\view\customer\customerresource\add.html";i:1532518657;s:88:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\layout\default.html";i:1531976707;s:85:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\meta.html";i:1531976707;s:87:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\script.html";i:1531976707;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <!-- <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Platform_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-platform_id" data-rule="required" data-source="promote/platform/index" class="form-control selectpage" name="row[platform_id]" type="text" value="">
        </div>
    </div> -->
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Platform_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[platform_id]', $platform, null, ['class'=>'form-control selectpicker',  'data-rule'=>'required']); ?>
            <!--<input id="c-platform_id" data-rule="required" data-source="salesmanagement/customerlisttabs/getPlatform" class="form-control selectpage" name="row[platform_id]" type="text" value="">-->
        </div>
    </div>
    <!-- <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Backoffice_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-backoffice_id" data-rule="required" data-source="backoffice/index" class="form-control selectpage" name="row[backoffice_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
