<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\phpStudy\WWW\crm.aicheyide.com\public/../application/admin\view\auth\admin\add.html";i:1531656681;s:76:"D:\phpStudy\WWW\crm.aicheyide.com\application\admin\view\layout\default.html";i:1531656681;s:73:"D:\phpStudy\WWW\crm.aicheyide.com\application\admin\view\common\meta.html";i:1531656681;s:75:"D:\phpStudy\WWW\crm.aicheyide.com\application\admin\view\common\script.html";i:1531656681;}*/ ?>
<!DOCTYPE html>
...
<form id="add-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('group[]', $groupdata, null, ['class'=>'form-control selectpicker max-h', 'multiple'=>'', 'data-rule'=>'required']); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="group" class="control-label col-xs-12 col-sm-2"><?php echo __('所属角色'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
                <?php echo build_select('row[rule_message]', $siteList, null, ['class'=>'form-control selectpicker',  'data-rule'=>'required']); ?> 
    ...
    <div class="form-group">
        <label for="openid" class="control-label col-xs-12 col-sm-2"><?php echo __('Open id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="openid" name="row[openid]" autocomplete="off" value=""  placeholder="<?php echo __('Open id xuan tian'); ?>"/>
        </div>
    </div>
    <div class="form-group">
