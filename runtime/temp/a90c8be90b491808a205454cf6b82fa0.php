<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:105:"D:\phpstudy\PHPTutorial\WWW\crm.aicheyide.com\public/../application/admin\view\general\profile\index.html";i:1532573933;s:88:"D:\phpstudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\layout\default.html";i:1532573933;s:85:"D:\phpstudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\meta.html";i:1532573933;s:87:"D:\phpstudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\script.html";i:1532573933;}*/ ?>
<!DOCTYPE html>
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="profile-avatar-container">
                            <img class="profile-user-img img-responsive img-circle plupload" src="https://static.aicheyide.com<?php echo $admin['avatar']; ?>" alt="">
                        ...
                        <div class="form-group">
                            <label for="openid" class="control-label"><?php echo __('Open id'); ?>:</label>
                            <input type="text" class="form-control" disabled placeholder="<?php echo __('Get Wechat Push Message，请勿随意修改'); ?>" value="<?php echo $admin['openid']; ?>" name="row[openid]" />
                        </div>
                        <div class="form-group">
