<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:113:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\public/../application/admin\view\vehiclemanagement\newcars\add.html";i:1532673156;s:88:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\layout\default.html";i:1531976707;s:85:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\meta.html";i:1531976707;s:87:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\script.html";i:1531976707;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-carnumber" class="form-control" name="row[carnumber]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Reservecar'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-reservecar" class="form-control" name="row[reservecar]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-licensenumber" data-rule="required" class="form-control" name="row[licensenumber]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Presentationcondition'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-presentationcondition" class="form-control " rows="5" name="row[presentationcondition]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
