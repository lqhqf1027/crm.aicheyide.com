<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:114:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\public/../application/admin\view\vehiclemanagement\rentcar\edit.html";i:1532662160;s:88:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\layout\default.html";i:1531976707;s:85:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\meta.html";i:1531976707;s:87:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\script.html";i:1531976707;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-cashpledge" data-rule="required" class="form-control" name="row[cashpledge]" type="number" value="<?php echo $row['cashpledge']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Threemonths'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-threemonths" data-rule="required" class="form-control" name="row[threemonths]" type="number" value="<?php echo $row['threemonths']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Sixmonths'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-sixmonths" data-rule="required" class="form-control" name="row[sixmonths]" type="number" value="<?php echo $row['sixmonths']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Manysixmonths'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-manysixmonths" data-rule="required" class="form-control" name="row[manysixmonths]" type="number" value="<?php echo $row['manysixmonths']; ?>">
        </div>
    </div>
    <!-- <div class="form-group">
