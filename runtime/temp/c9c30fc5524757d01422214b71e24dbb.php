<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:114:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\public/../application/admin\view\rentcar\vehicleinformation\add.html";i:1532682449;s:88:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\layout\default.html";i:1531976707;s:85:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\meta.html";i:1531976707;s:87:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\script.html";i:1531976707;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Cashpledge'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-cashpledge" data-rule="required" class="form-control" name="row[cashpledge]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Threemonths'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-threemonths" data-rule="required" class="form-control" name="row[threemonths]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Sixmonths'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-sixmonths" data-rule="required" class="form-control" name="row[sixmonths]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Manysixmonths'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-manysixmonths" data-rule="required" class="form-control" name="row[manysixmonths]" type="number">
        </div>
    </div>
    ...
    <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="input-group">
                    <input id="c-drivinglicenseimages" data-rule="required" class="form-control" size="50" name="row[drivinglicenseimages]" type="text" value="">
                    <div class="input-group-addon no-border no-padding">
                        <span><button type="button" id="plupload-drivinglicenseimages" class="btn btn-danger plupload" data-input-id="c-drivinglicenseimages" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="true" data-preview-id="p-images"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                        <span><button type="button" id="fachoose-drivinglicenseimages" class="btn btn-primary fachoose" data-input-id="c-drivinglicenseimages" data-mimetype="image/*" data-multiple="true"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
                    </div>
                    <span class="msg-box n-right" for="c-drivinglicenseimages"></span>
                </div>
                <ul class="row list-inline plupload-preview" id="p-drivinglicenseimages"></ul>
            </div>
    </div>
    <div class="form-group">
