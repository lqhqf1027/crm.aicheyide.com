<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:122:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\public/../application/admin\view\salesmanagement\customerlisttabs\index.html";i:1532913955;s:88:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\layout\default.html";i:1531976707;s:85:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\meta.html";i:1531976707;s:87:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\script.html";i:1531976707;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="panel-heading">
        ...
        <ul class="nav nav-tabs" >
            <li class="active text-center" style=""><a href="#new_customer" data-toggle="tab" style="font-weight: bold">新客户&nbsp;<span class="pull-right-container"><small class="badge pull-right bg-red"><?php echo $newCustomTotal; ?></small></span></a></li>
            <li><a href="#relation" data-toggle="tab" style="font-weight: bold" class="text-center" >待联系&nbsp;<span class="pull-right-container"><small class="badge pull-right bg-red"><?php echo $relationTotal; ?></small></span></a></li>
            <li><a href="#intention" data-toggle="tab" style="color:#18bc9c;font-weight: bold" class="text-center">有意向&nbsp;<span class="pull-right-container"><small class="badge pull-right bg-red"><?php echo $intentionTotal; ?></small></span></a></li>
            <li><a href="#nointention" data-toggle="tab" style="font-weight: bold" class="text-center">暂无意向&nbsp;<span class="pull-right-container"><small class="badge pull-right bg-red"><?php echo $nointentionTotal; ?></small></span></a></li>
            <li><a href="#giveup" data-toggle="tab" style="font-weight: bold" class="text-center">已放弃&nbsp;<span class="pull-right-container"><small class="badge pull-right bg-red"><?php echo $giveupTotal; ?></small></span></a></li>
            <li><a href="#overdue" data-toggle="tab" style="color:#e74c3c;font-size:15px;font-weight: bold" class="text-center">跟进时间过期客户&nbsp;<span class="pull-right-container"><small class="badge pull-right bg-red"><?php echo $overdueTotal; ?></small></span></a></li>
        </ul>
    </div>
