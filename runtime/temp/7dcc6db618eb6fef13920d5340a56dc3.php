<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:104:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\public/../application/admin\view\order\salesorder\add.html";i:1532917278;s:88:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\layout\default.html";i:1531976707;s:85:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\meta.html";i:1531976707;s:87:"D:\phpStudy\PHPTutorial\WWW\crm.aicheyide.com\application\admin\view\common\script.html";i:1531976707;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <label class="control-label col-xs-12 col-sm-2">
            <strong> <?php echo __('请仔细填写录入以下客户资料'); ?>:</strong>
        </label>
    </div>
    <h3>
        <center>基本资料</center>
    ...
    <br>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('销售车型/方案'); ?>:</label>
        <div class="col-xs-12 col-sm-8">

            <select id="c-plan_acar_name" data-rule="required" class="form-control selectpicker" name="row[plan_acar_name]">
                ...
                <option value="<?php echo $vo['brand_logoimage']; ?>" disabled><?php echo $vo['brand_name']; ?></option>
                <?php if(is_array($vo['data']) || $vo['data'] instanceof \think\Collection || $vo['data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo_s): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo $vo_s['id']; ?>"><?php echo $vo_s['models_name']; ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
                ...
                <label for="row[genderdata]-<?php echo $key; ?>">
                    <input id="row[genderdata]-<?php echo $key; ?>" name="row[genderdata]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"male"))): ?>checked<?php endif; ?>
                    /> <?php echo $vo; ?></label>
    ...
    <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="input-group">
                    <input id="c-deposit_contractimages" data-rule="required" class="form-control" size="50" name="row[deposit_contractimages]" type="text">
                    <div class="input-group-addon no-border no-padding">
                        <span>
                            <button type="button" id="plupload-deposit_contractimages" class="btn btn-danger plupload" data-input-id="c-deposit_contractimages"
                                ...
                                <i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button>
                        </span>
                        <span>
                            <button type="button" id="fachoose-deposit_contractimages" class="btn btn-primary fachoose" data-input-id="c-deposit_contractimages"
                                data-mimetype="image/*" data-multiple="true">
                                <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                        </span>
                    </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="input-group">
                    <input id="c-deposit_receiptimages" data-rule="required" class="form-control" size="50" name="row[deposit_receiptimages]" type="text">
                    <div class="input-group-addon no-border no-padding">
                        <span>
                        ...
                        <span>
                            <button type="button" id="fachoose-deposit_receiptimages" class="btn btn-primary fachoose" data-input-id="c-deposit_receiptimages"
                                data-mimetype="image/*" data-multiple="true">
                                <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                        </span>
                    </div>
    ...
    <div id="introduce-view" style="display: none">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <input id="c-turn_to_introduce_card" data-rule="IDcard" class="form-control" name="row[turn_to_introduce_card]" type="text" placeholder="可后期再填写，不必填">
            </div>
        </div>
    </div>
    <h3>
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    ...
                    <span>
                        <button type="button" id="fachoose-id_cardimages" class="btn btn-primary fachoose" data-input-id="c-id_cardimages" data-mimetype="image/*"
                            data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    ...
                    <span>
                        <button type="button" id="fachoose-drivers_licenseimages" class="btn btn-primary fachoose" data-input-id="c-drivers_licenseimages"
                            data-mimetype="image/*" data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    ...
                    <span>
                        <button type="button" id="fachoose-residence_bookletimages" class="btn btn-primary fachoose" data-input-id="c-residence_bookletimages"
                            data-mimetype="image/*" data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    ...
                    <span>
                        <button type="button" id="fachoose-housingimages" class="btn btn-primary fachoose" data-input-id="c-housingimages" data-mimetype="image/*"
                            data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    ...
                    <span>
                        <button type="button" id="fachoose-bank_cardimages" class="btn btn-primary fachoose" data-input-id="c-bank_cardimages" data-mimetype="image/*"
                            data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    ...
                    <span>
                        <button type="button" id="fachoose-application_formimages" class="btn btn-primary fachoose" data-input-id="c-application_formimages"
                            data-mimetype="image/*" data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8 col-md-6">
            <div class="input-group">
                <input id="c-call_listfiles" data-rule="required" class="form-control" size="50" name="row[call_listfiles]" type="text" placeholder="请上传PDF或EXCEL格式！！！">
                <div class="input-group-addon no-border no-padding">
                    <span>
                    ...
                    <span>
                        ...
                        <button type="button" id="fachoose-call_listfiles" class="btn btn-info get_call_listfiles"  data-multiple="true">
                            <i class="fa fa-download"></i> <?php echo __('点击这里一键获取通话清单'); ?></button>
                    </span>
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-credit_reportimages" class="form-control" size="50" name="row[credit_reportimages]" type="text">
                <div class="input-group-addon no-border no-padding">
                    <span>
                        <button type="button" id="plupload-credit_reportimages" class="btn btn-danger plupload" data-input-id="c-credit_reportimages"
                            data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="true" data-preview-id="p-credit_reportimages">
                            <i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button>
                    </span>
                    <span>
                        <button type="button" id="fachoose-credit_reportimages" class="btn btn-primary fachoose" data-input-id="c-credit_reportimages"
                            data-mimetype="image/*" data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-guarantee_id_cardimages" class="form-control" size="50" name="row[guarantee_id_cardimages]" type="text">
                <div class="input-group-addon no-border no-padding">
                    <span>
                        <button type="button" id="plupload-guarantee_id_cardimages" class="btn btn-danger plupload" data-input-id="c-guarantee_id_cardimages"
                            data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="true" data-preview-id="p-guarantee_id_cardimages">
                            <i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button>
                    </span>
                    <span>
                        <button type="button" id="fachoose-guarantee_id_cardimages" class="btn btn-primary fachoose" data-input-id="c-guarantee_id_cardimages"
                            data-mimetype="image/*" data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-guarantee_agreementimages" class="form-control" size="50" name="row[guarantee_agreementimages]" type="text">
                <div class="input-group-addon no-border no-padding">
                    <span>
                        <button type="button" id="plupload-guarantee_agreementimages" class="btn btn-danger plupload" data-input-id="c-guarantee_agreementimages"
                            data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="true" data-preview-id="p-guarantee_agreementimages">
                            <i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button>
                    </span>
                    <span>
                        <button type="button" id="fachoose-guarantee_agreementimages" class="btn btn-primary fachoose" data-input-id="c-guarantee_agreementimages"
                            data-mimetype="image/*" data-multiple="true">
                            <i class="fa fa-list"></i> <?php echo __('Choose'); ?></button>
                    </span>
                </div>
    ...
    <b style="color: #ddd"><center><i>--我是有底线的--</i></center></b>
    <!-- <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
                ...
                <label for="row[review_the_data]-<?php echo $key; ?>">
                    <input id="row[review_the_data]-<?php echo $key; ?>" name="row[review_the_data]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"not_through"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-delivery_datetime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true"
                name="row[delivery_datetime]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div> -->
