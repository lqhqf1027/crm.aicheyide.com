...
define('../libs/require-css/css.min!../libs/bootstrap-table/dist/bootstrap-table-fixed-columns',[],function(){});
(function ($) {
    'use strict';
...
define("bootstrap-table-fixed-columns", ["bootstrap-table","css!../libs/bootstrap-table/dist/bootstrap-table-fixed-columns.css"], (function (global) {
    return function () {
        var ret, fn;
...
<<<<<<< HEAD
define('table',['jquery', 'bootstrap', 'moment', 'moment/locale/zh-cn', 'bootstrap-table','bootstrap-table-fixed-columns', 'bootstrap-table-lang', 'bootstrap-table-export', 'bootstrap-table-commonsearch', 'bootstrap-table-template'], function ($, undefined, Moment) {
=======
