...
const data = {
    "plan": {
        ...
        "popularity": null,
        "different_schemes": null,
        "collection": 1,
        "fabulous": 0,
        "models": {
            "name": "大众 速腾 2018款 1.6L 手动舒适型",
        ...
        "label": {
            "name": "免首付",
            "lableimages": "https://static.aicheyide.com/uploads/20181116/77f05151e55070e69993a8bb8ebef087.png",
            "rotation_angle": 0,
            "status_text": ""
        },
        "companystore": {
    ...
    "guesslike": [{
        ...
        "models_name": "大众 速腾 2018款 1.6L 手动时尚型"
    }]
}
...
Page({
    data: {
        ...data,
        defParams: data.plan.models.vehicle_configuration['基本参数'],
    },
    onLoad(options) {
        console.log(options)
